...
__host__ void sort(Population* gpu_P) {
    ...
    gpuErrchk( cudaPeekAtLastError() ,  "sort kernel call");
    gpuErrchk( cudaDeviceSynchronize() , "sync sort");
    printf("back from sort\n");
